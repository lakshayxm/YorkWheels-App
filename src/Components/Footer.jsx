...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-pink-600 to-pink-800 text-white">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-pink-100 hover:text-white transition-colors">Home</Link></li>
              <li><Link to="/services" className="text-pink-100 hover:text-white transition-colors">Services</Link></li>
              <li><Link to="/contact" className="text-pink-100 hover:text-white transition-colors">Contact</Link></li>
              <li><Link to="/about" className="text-pink-100 hover:text-white transition-colors">About Us</Link></li>
            </ul>
          </div>
